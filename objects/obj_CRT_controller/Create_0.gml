...
//camera_set_view_size(view_camera[0], 256, 192); //See common resolution sizes above.
...
scr_CRT_init_shader(view_camera[0], false, 0.12, true, true, true, 0.03, 80.0, 1.0, true, 0.175, application_surface);