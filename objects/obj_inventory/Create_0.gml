...
inv_items[# ITEM.BOMB, INVENTORY_STAT.OWNED] = false;
...
// gems
inv_items[# GEM.EXEMPLAR, INVENTORY_STAT.DAMAGE] = -1;
inv_items[# GEM.EXEMPLAR, INVENTORY_STAT.USES_AMMO] = false;
inv_items[# GEM.EXEMPLAR, INVENTORY_STAT.AMMO] = -1;
inv_items[# GEM.EXEMPLAR, INVENTORY_STAT.OWNED] = false;
inv_items[# GEM.EXEMPLAR, INVENTORY_STAT.MANA_TYPE] = MANA_TYPE.EMERALD;
inv_items[# GEM.EXEMPLAR, INVENTORY_STAT.MANA_COST] = 1;

inv_items[# GEM.STRENGTH, INVENTORY_STAT.DAMAGE] = -1;
inv_items[# GEM.STRENGTH, INVENTORY_STAT.USES_AMMO] = false;
inv_items[# GEM.STRENGTH, INVENTORY_STAT.AMMO] = -1;
inv_items[# GEM.STRENGTH, INVENTORY_STAT.OWNED] = false;
inv_items[# GEM.STRENGTH, INVENTORY_STAT.MANA_TYPE] = MANA_TYPE.EMERALD;
inv_items[# GEM.STRENGTH, INVENTORY_STAT.MANA_COST] = 1;

inv_items[# GEM.STAMINA, INVENTORY_STAT.DAMAGE] = -1;
inv_items[# GEM.STAMINA, INVENTORY_STAT.USES_AMMO] = false;
inv_items[# GEM.STAMINA, INVENTORY_STAT.AMMO] = -1;
inv_items[# GEM.STAMINA, INVENTORY_STAT.OWNED] = false;
inv_items[# GEM.STAMINA, INVENTORY_STAT.MANA_TYPE] = MANA_TYPE.EMERALD;
inv_items[# GEM.STAMINA, INVENTORY_STAT.MANA_COST] = 1;
