...
{
	if (!obj_inventory.inv_items[# ITEM.BOMB, INVENTORY_STAT.OWNED])
	{
		obj_inventory.inv_items[# ITEM.BOMB, INVENTORY_STAT.OWNED] = true;
	}
	
	obj_inventory.inv_items[# ITEM.BOMB, INVENTORY_STAT.AMMO] += _amount;
}